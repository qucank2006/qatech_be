...
exports.checkPurchase = async (req, res) => {
  try {
    ...
    // Kiểm tra có order completed chứa sản phẩm này không
...
// Admin hoặc Employee phản hồi review
exports.replyReview = async (req, res) => {
  try {
    ...
    // Chỉ admin hoặc employee mới được reply
...
// Xóa review (Admin, Employee hoặc chủ review)
exports.deleteReview = async (req, res) => {
  try {
    ...
    // Chỉ admin, employee hoặc người tạo review mới được xóa
